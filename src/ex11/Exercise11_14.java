...
public class Exercise11_14 {
	...
	static int displayMenu() {
		...
		System.out.println();
		System.out.println("원하는 메뮤를 선택하세요.(1~3)");
...
//		}
	...
	//데이터를 입력받는 메서드 inputRecord()
	static void inputRecord() {
		System.out.println("1. 학생성적 입력하기");
		System.out.println("[이름,반,번호,국어성적,영어성적,수학성적]의 "
				+ "순서로 공백없이 입력하세요.");
		...
		while(true) {
			...
			try {
				...
				e.printStackTrace();
				System.out.println("입력오류입니다. 이름,반,번호,국어성적,영어성적,수학성적의 "
						+ "순서로 입력하세요.");
			}
	...
	//데이터 목록을 보여주는 메서드 displayRecord
